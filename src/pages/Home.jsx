...
const PILLARS = [
  ...
  },
  {
    ...
    desc: 'We are a licensed general contractor. Once the damage is remediated, we handle every trade — drywall, flooring, kitchens, baths, and more.',
    link: '/projects',
  },
]
...
const PROCESS = [
  ...
  { step: '03', title: 'We Rebuild It', desc: 'As a full general contractor, we handle the complete reconstruction — one company, one contract, from bare studs back to a finished home.' },
]
    ...
    <>
      ...
      <section className="hero">
        <div className="container hero__split">
          ...
          <div className="hero__visual">
            <img src="/Background_IIRCR.png" alt="Greg and Zach — Ukrainian Restoration founders" />
          </div>
        </div>
      ...
      <section className="section">
        <div className="container">
          <div className="sec-hd">
            ...
            <h2 className="sec-title">From Crisis to Completed Home</h2>
            <p className="sec-sub">
        ...
        <div className="container">
          <div className="home-split">
            ...
            <div className="home-split__text">
              ...
              <h2>One Company. The Whole Job.</h2>
              <p>
              ...
              <p>
                As a licensed general contractor <em>and</em> IICRC-certified restoration firm,
              ...
              <div className="split-features">
                ...
                <div className="split-feature">
                  ...
                  <div>
                    ...
                    <p>We document everything from day one to support your claim.</p>
                  </div>
                </div>
                <div className="split-feature">
                  <div className="split-feature__icon"><ShieldCheckIcon /></div>
      ...
      <section className="section">
        <div className="container">
          <div className="sec-hd">
            ...
            <h2 className="sec-title">Respond. Restore. Rebuild.</h2>
        ...
        <div className="container">
          <div className="home-split home-split--reverse">
            <div className="home-split__text">
              ...
              <h2>Built on Heritage &amp; Hard Work</h2>
              <p>
              ...
              <p>
                ...
                independence — that&apos;s how we show up to every job.
              </p>
              <div className="section-actions">
      ...
      <section className="cta-banner">
        ...
        <p>
          ...
          an immediate response, or send a message for a free estimate on any project.
        </p>
